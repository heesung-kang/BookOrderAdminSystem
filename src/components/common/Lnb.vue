<template>
  <section class="lnb-wrap">
    <aside class="side-bar" :class="{ active: isActive }">
      ...
      <nav class="lnb">
        <ul @click="close">
          <li :class="{ active: activeStatus === 1 }"><router-link to="/OrderList">주문 목록</router-link></li>
          <li :class="{ active: activeStatus === 2 }"><router-link to="/DeliveryList">출고 목록</router-link></li>
