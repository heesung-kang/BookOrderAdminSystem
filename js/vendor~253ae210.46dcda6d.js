 ...
 * limitations under the License.
 */
class Ko{constructor(t,e){this._firestore=t,this._commitHandler=e,this._mutations=[],this._committed=!1,this._dataReader=no(t)}set(t,e,n){this._verifyNotCommitted();const r=Go(t,this._firestore),i=Lo(r.converter,e,n),s=ro(this._dataReader,"WriteBatch.set",r._key,i,null!==r.converter,n);return this._mutations.push(s.toMutation(r._key,Ue.none())),this}update(t,e,n,...r){this._verifyNotCommitted();const i=Go(t,this._firestore);let s;return s="string"==typeof(e=Object(o.n)(e))||e instanceof Gs?ao(this._dataReader,"WriteBatch.update",i._key,e,n,r):oo(this._dataReader,"WriteBatch.update",i._key,e),this._mutations.push(s.toMutation(i._key,Ue.exists(!0))),this}delete(t){this._verifyNotCommitted();const e=Go(t,this._firestore);return this._mutations=this._mutations.concat(new Ye(e._key,Ue.none())),this}commit(){return this._verifyNotCommitted(),this._committed=!0,this._mutations.length>0?this._commitHandler(this._mutations):Promise.resolve()}_verifyNotCommitted(){if(this._committed)throw new I(b.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")}}function Go(t,e){if((t=Object(o.n)(t)).firestore!==e)throw new I(b.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.");return t}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Wo(){return new so("serverTimestamp")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Qo(t){return Hs(t=Es(t,Bs)),new Ko(t,e=>Ho(t,e))
/**
 * @license
 * Copyright 2021 Google LLC
 *
