 ...
 * limitations under the License.
 */
class Gs{constructor(t){this._byteString=t}static fromBase64String(t){try{return new Gs(ct.fromBase64String(t))}catch(t){throw new I(b.INVALID_ARGUMENT,"Failed to construct data from Base64 string: "+t)}}static fromUint8Array(t){return new Gs(ct.fromUint8Array(t))}toBase64(){return this._byteString.toBase64()}toUint8Array(){return this._byteString.toUint8Array()}toString(){return"Bytes(base64: "+this.toBase64()+")"}isEqual(t){return this._byteString.isEqual(t._byteString)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ws{constructor(...t){for(let e=0;e<t.length;++e)if(0===t[e].length)throw new I(b.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.");this._internalPath=new j(t)}isEqual(t){return this._internalPath.isEqual(t._internalPath)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Ys{constructor(t,e){if(!isFinite(t)||t<-90||t>90)throw new I(b.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t);if(!isFinite(e)||e<-180||e>180)throw new I(b.INVALID_ARGUMENT,"Longitude must be a number between -180 and 180, but was: "+e);this._lat=t,this._long=e}get latitude(){return this._lat}get longitude(){return this._long}isEqual(t){return this._lat===t._lat&&this._long===t._long}toJSON(){return{latitude:this._lat,longitude:this._long}}_compareTo(t){return L(this._lat,t._lat)||L(this._long,t._long)}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
function Bo(t){t=Es(t,Cs);const e=Es(t.firestore,qs);return js(zs(e),t._key).then(n=>Yo(e,t,n))}class qo extends xo{constructor(t){super(),this.firestore=t}convertBytes(t){return new Gs(t)}convertReference(t){const e=this.convertDocumentKey(t,this.firestore._databaseId);return new Cs(this.firestore,null,e)}}function Ho(t){t=Es(t,As);const e=Es(t.firestore,qs),n=zs(e),r=new qo(e);return To(t._query),$s(n,t._query).then(n=>new jo(e,r,t,n))}function zo(t,e,n){t=Es(t,Cs);const r=Es(t.firestore,qs),i=Po(t.converter,e,n);return Qo(r,[io(ro(r),"setDoc",t._key,i,null!==t.converter,n).toMutation(t._key,Ue.none())])}function Ko(t,e,n,...r){t=Es(t,Cs);const i=Es(t.firestore,qs),s=ro(i);let a;return a="string"==typeof(e=Object(o.n)(e))||e instanceof Ws?co(s,"updateDoc",t._key,e,n,r):ao(s,"updateDoc",t._key,e),Qo(i,[a.toMutation(t._key,Ue.exists(!0))])}function Go(t){return Qo(Es(t.firestore,qs),[new Ye(t._key,Ue.none())])}function Wo(t,e){const n=Es(t.firestore,qs),r=Ns(t),i=Po(t.converter,e);return Qo(n,[io(ro(t.firestore),"addDoc",r._key,i,null!==t.converter,{}).toMutation(r._key,Ue.exists(!1))]).then(()=>r)}function Qo(t,e){return function(t,e){const n=new E;return t.asyncQueue.enqueueAndForget(async()=>async function(t,e,n){const r=ms(t);try{const t=await function(t,e){const n=w(t),r=x.now(),i=e.reduce((t,e)=>t.add(e.key),mn());let s,o;return n.persistence.runTransaction("Locally write mutations","readwrite",t=>{let a=on(),c=mn();return n.Gi.getEntries(t,i).next(t=>{a=t,a.forEach((t,e)=>{e.isValidDocument()||(c=c.add(t))})}).next(()=>n.localDocuments.getOverlayedDocuments(t,a)).next(i=>{s=i;const o=[];for(const t of e){const e=qe(t,s.get(t.key).overlayedDocument);null!=e&&o.push(new Ke(t.key,e,Pt(e.value.mapValue),Ue.exists(!0)))}return n.mutationQueue.addMutationBatch(t,r,o,e)}).next(e=>{o=e;const r=e.applyToLocalDocumentSet(s,c);return n.documentOverlayCache.saveOverlays(t,e.batchId,r)})}).then(()=>({batchId:o.batchId,changes:un(s)}))}(r.localStore,e);r.sharedClientState.addPendingMutation(t.batchId),function(t,e,n){let r=t.hc[t.currentUser.toKey()];r||(r=new nt(L)),r=r.insert(e,n),t.hc[t.currentUser.toKey()]=r}(r,t.batchId,n),await ls(r,t.changes),await vi(r.remoteStore)}catch(t){const e=Ri(t,"Failed to persist write");n.reject(e)}}(await Fs(t),e,n)),n.promise}(zs(t),e)}function Yo(t,e,n){const r=n.docs.get(e._key),i=new qo(t);return new Fo(t,i,e._key,r,new Uo(n.hasPendingWrites,n.fromCache),e.converter)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Zo(){return new oo("serverTimestamp")}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function ta(t){return zs(t=Es(t,qs)),new Xo(t,e=>Qo(t,e))
/**
 * @license
 * Copyright 2021 Google LLC
 *
